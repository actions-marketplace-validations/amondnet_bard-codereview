  ...
  const loadChat = async (context: Context) => {
    ...
    try {
      ...
      await context.octokit.issues.createComment({
        ...
        body: `Seems you are using me but didn't get BARD_API_KEY seted in Variables/Secrets for this repo. you could follow [readme](https://github.com/anc95/Bard-CodeReview) for more information`,
      });
      return null;
    }
  };
